...
(function () {
  ...
  var HEADER = ''
    ...
    +   '<a class="logo" href="index.html"><img src="' + SEAL + '" alt="TopRatedVAs seal" style="width:38px;height:38px"><span data-i18n="logoA">TopRated</span>VAs<span class="tld">.com</span></a>'
    +   '<nav class="navlinks">'
  ...
  var FOOTER = ''
    ...
    +   '<div>'
    +     '<div class="logo" style="color:#fff;margin-bottom:10px"><img src="' + SEAL + '" alt="TopRatedVAs seal" style="width:38px;height:38px">TopRatedVAs<span class="tld">.com</span></div>'
